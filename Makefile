...
#    Updated: 2019/06/01 16:50:08 by aelouarg         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILEPRINTF	= flags.c float.c float_manager.c float_tools.c ldouble.c ldouble_manager.c ldouble_tools.c ft_printf.c numbers.c numbers2.c strings.c time.c tools.c colors.c non_printable.c tools2.c
OBJ_DIR 	= obj
HDR 	=  libft.h printf.h
OBJ		=  $(addprefix $(OBJ_DIR)/, $(FILENAMES:.c=.o))
OBJ		+=  $(addprefix $(OBJ_DIR)/, $(FILEPRINTF:.c=.o))
